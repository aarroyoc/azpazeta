...
#define AZPAZETA_VERSION_MINOR 1
#define AZPAZETA_VERSION_PATCH 0
#define AZPAZETA_VERSION_STR "2.1.0"
#define AZPAZETA_VERSION_FLOAT 2.1
#define AZPAZETA_NAME "LINK"
#define AZPAZETA_WX_NAME wxT("LINK")
